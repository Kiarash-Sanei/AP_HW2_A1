...
public class OldGameMenuScreen extends MenuScreen {
    ...
    public OldGameMenuScreen(AtomicBomber atomicBomber) {
        super(atomicBomber);
        assetLoader();
        ...
        shootCount = 0;
        accuracy = 0f;
        GameInformation gameInformation = user.getGameInformation();
        wave = gameInformation.wave;
        switch (wave) {
            case first:
        ...
        iceMode = false;
        nextWave = false;
        buildings = gameInformation.buildings;
        migCount = wave.getMig();
        migs = gameInformation.migs;
        tanks = gameInformation.tanks;
        trees = gameInformation.trees;
        trenches = gameInformation.trenches;
        trucks = gameInformation.trucks;
